 ...
 * @author developer
 */
@WebServlet(name = "HorarioList", urlPatterns = {"/HorarioList"})
public class HorarioList extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            //HORARIOS
            List<HorarioTO> list = horarioDAO.list();
            ...
            System.out.println("ERROR @CanchaList: " + e);
        }
    }
