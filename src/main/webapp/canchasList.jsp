        ...
        <div class="row-offcanvas row-offcanvas-left">
            <div id="sidebar" class="sidebar-offcanvas">
                <div class="col-md-12">
                    ...
                    <button style="margin-bottom: 5px;" class="btn btn-warning btn-block" id="editarCanchaBtn" data-toggle="modal" data-target="#myNewModal">
                        <span class="fas fa-edit"></span> Editar cancha
                    </button>
...
<!--                    <hr>
            ...
            <div id="main">
                <div class="col-md-12">
                    ...
                    <h2><span class="fas fa-futbol"></span> Canchas</h2>
                    <hr>
                    <div class="col-md-12"> 
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <table id="myTable" class="table table-bordered table-hover nowrap display">
                                    <thead>
                                        <tr class="thead-dark">
                                    ...
                                    <tbody>
                                        <c:forEach var="cancha" items="${canchas}">
                                            <tr>
                                                <td class="text-center">${cancha.id}</td>
                                                <td>${cancha.nombre}</td>
        ...
        <div class="modal fade" id="myNewModal" role="dialog" aria-labelledby="myNewModal" aria-hidden="true">
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    <form action="CanchaNew" method="post" class="form-horizontal" role="form" id="formulario" name="formulario">
                        <div class="modal-header">
                            <h3 class="modal-title" id="myModalLabel"><span class="fas fa-thumbtack"></span> Cancha</h3>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-row mb-2">
                                            <div class="col-md-12">
                                                ...
                                                <input type="text"  class="form-control form-control-sm" name="nombre" id="nombre" autofocus="">
                                            </div>
                                        </div>

                                        <div class="form-row mb-2">
                                            <div class="col">
                                                <span><i class="fas fa-id-card"></i> Descripción</span>                                                 
    ...
    <script src="js/canchasScripts.js"></script>
